...
//作成
CBattery *CBattery::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nTime, float fSpeed, float fHeight, float fFriction, float fMaxSpeed, float fGravity, int nStartTime)
{
	CBattery *pBattery;
	...
	if (pBattery != NULL)
	{
		...
		pBattery->m_fMaxSpeed = fMaxSpeed;
		pBattery->m_fGravity = fGravity;
		pBattery->m_nTime = nStartTime;
	}
	return pBattery;
}
...
void CBattery::RandomBomb(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
	...
	case CBomb::BOMB_NORMAL:
		CNormalBomb::Create(BombPos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), move, m_fFriction, m_fMaxSpeed, m_fGravity);
		break;
	case CBomb::BOMB_ICE:
		CIceBomb::Create(BombPos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), move, m_fFriction, m_fMaxSpeed, m_fGravity);
		break;
	case CBomb::BOMB_FIRE:
		CFireBomb::Create(BombPos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), move, m_fFriction, m_fMaxSpeed, m_fGravity);
		break;
	case CBomb::BOMB_POISON:
		CPoisonBomb::Create(BombPos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), move, m_fFriction, m_fMaxSpeed, m_fGravity);
		break;
	case CBomb::BOMB_CONFUSION:
		CConfusionBomb::Create(BombPos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), move, m_fFriction, m_fMaxSpeed, m_fGravity);
		break;
	default:
		break;
	}
