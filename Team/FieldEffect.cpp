...
CFieldEffect::CFieldEffect(PRIORITY nPriority) : CEffect_base::CEffect_base(nPriority)
{
...
HRESULT CFieldEffect::Init(D3DXVECTOR3 size,
	...
	int FiledLife)
{
	CEffect_base::Init(size, pos, D3DXVECTOR2(1.0f, 1.0f));
	...
	int FiledLife)
{
	...
	pFieldEffect = new CFieldEffect(CScene::PRIORITY_EFFECT);
