...
HRESULT CGame::Init(D3DXVECTOR3 /*pos*/)
{
	...
	//| プレイヤーの生成 |
	//+------------------+
	CPlayer::Create(D3DXVECTOR3(-150.0f, 0.0f, 150.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), CPlayer::PLAYER_TYPE_1P);
	CPlayer::Create(D3DXVECTOR3(150.0f, 0.0f, 150.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), CPlayer::PLAYER_TYPE_2P);
	CPlayer::Create(D3DXVECTOR3(-150.0f, 0.0f, -150.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), CPlayer::PLAYER_TYPE_3P);
	CPlayer::Create(D3DXVECTOR3(150.0f, 0.0f, -150.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), CPlayer::PLAYER_TYPE_4P);
	...
	//砲台生成
	CBattery::Create(D3DXVECTOR3(0.0f, 0.0f, -150.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 120);

	CSound::Play(1);
	CSound::ControlVoice(1, 0.1f);
	return S_OK;
}
