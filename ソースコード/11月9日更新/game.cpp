...
HRESULT CGame::Init(D3DXVECTOR3 /*pos*/)
{
	...
	//| プレイヤーの生成 |
	//+------------------+
	D3DXVECTOR3 posStart[4] = { D3DXVECTOR3(-100.0f, 0.0f, 100.0f), D3DXVECTOR3(100.0f, 0.0f, 100.0f), D3DXVECTOR3(-100.0f, 0.0f, -100.0f), D3DXVECTOR3(100.0f, 0.0f, -100.0f), };
	bool bEntry[4] = { false };
	...
	//CCollisionSphere::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f), 250.0f, 16, 16, CCollisionSphere::COLLISION_S_TYPE::COLLISION_S_TYPE_ICE, -1.0f);
