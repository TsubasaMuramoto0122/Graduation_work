...
void CPlayer::BadState(PLAYER_BAD_STATE state)
{
	...
	// ゲームが終わり、何らかの状態異常だったら
	if (CManager::GetGameEnd() == true && GetBadState() != PLAYER_BAD_STATE_NONE)
	{
		// 状態異常をを消す
		SetBadState(PLAYER_BAD_STATE_NONE);
