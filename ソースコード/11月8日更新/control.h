...
#define PLAYER_ATTACK_COOLTIME		(30)	// 攻撃後、再び攻撃できるまでの時間
#define PLAYER_SLIDING_MOVE			(1.2f)	// スライディング(回避)の移動量の基準値
#define PLAYER_SLIDING_TIME			(40)	// スライディング(回避)時間
...
#define PLAYER_KNOCKBACK_STAN		(120)	// ノックバック後のスタンの時間
#define PLAYER_GETUP_TIME			(30)	// スタン中、起き上がる時間
#define PLAYER_DEFEAT_KNOCKBACK		(19.0f)	// 敗北時のノックバックの大きさ
#define MAX_MOVE					(3.6f)	// 限界の移動量
#define MAX_SLIDE					(8.0f)	// 限界のスライド量
